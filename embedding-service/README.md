...
| `POST /recommend/rank` | Rank candidates with **Gradient Boosting** `train_model/models/gb.joblib` |
...
- **Training (F1, AUC, dataset, export `gb.joblib`):** [`train_model/README.md`](./train_model/README.md)
